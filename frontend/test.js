...
const BlackJack = () => {
  ...
  function playDealer() {
    ...
    let value = calculateValue(cards);
    while (value < 17) {
      let newCard = pickCards(1)[0];
      cards.push(newCard);
  ...
  return (
    <div className="border">
      <div className="gameboard">
        ...
        <h4 hidden={gamestate === Gamestate.BETTING}>
        ...
        <div className="buttons">
          ...
          <Button
            onClick={() => dealCards()}
            hidden={gamestate !== Gamestate.BETTING}
          ...
          <Button
            ...
            disabled={gamestate !== Gamestate.USER}
            hidden={gamestate !== Gamestate.USER}
          >
            Hit
          </Button>
          <Button
          ...
          <Button
            onClick={() => reset(true)}
            disabled={gamestate !== Gamestate.DONE}
            hidden={gamestate !== Gamestate.DONE}
          >
            Change Bet
          </Button>
          <Button
